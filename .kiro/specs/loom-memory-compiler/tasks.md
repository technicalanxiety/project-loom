...
- [ ] 1. Project scaffolding and infrastructure setup
  ...
  - [ ] 1.3 Create Dockerfile for loom-engine (multi-stage build)
  ...
  - [ ] 1.4 Create Caddyfile for reverse proxy configuration
  ...
  - [ ] 1.5 Create database connection pool initialization with online/offline separation
...
- [ ] 2. Database schema and SQL migrations
  - [ ] 2.1 Create sqlx migrations for core tables (001-002)
  ...
  - [ ] 2.2 Create sqlx migrations for predicate pack system (003-004)
  ...
  - [ ] 2.3 Create sqlx migrations for facts and procedures (005-006)
  ...
  - [ ] 2.4 Create sqlx migrations for resolution conflicts, namespace config, audit, and snapshots (007-010)
  ...
  - [ ] 2.5 Create sqlx migration for graph traversal function (011)
  ...
  - [ ] 2.6 Create sqlx migrations for predicate seed data (012-013)
  ...
  - [ ]* 2.7 Write property test for database schema constraints
...
- [ ] 3. Rust type definitions and database query layer
  - [ ] 3.1 Define core Rust types with serde
  ...
  - [ ] 3.2 Implement database query module for episodes
  ...
  - [ ] 3.3 Implement database query module for entities
  ...
  - [ ] 3.4 Implement database query module for facts
  ...
  - [ ] 3.5 Implement database query modules for predicates, audit, dashboard, and supporting tables
  ...
  - [ ]* 3.6 Write unit tests for database query layer
...
- [ ] 4. Ollama LLM client and embedding service
  - [ ] 4.1 Implement Ollama HTTP client with Azure OpenAI fallback
  ...
  - [ ] 4.2 Implement embedding generation service
  ...
  - [ ] 4.3 Implement extraction prompt execution
  ...
  - [ ] 4.4 Implement intent classification service
  ...
  - [ ]* 4.5 Write property test for embedding dimension consistency
  ...
  - [ ]* 4.6 Write unit tests for LLM client and services
...
- [ ] 6. Entity extraction and three-pass resolution
  - [ ] 6.1 Implement entity extraction prompt and orchestration
  ...
  - [ ] 6.2 Implement Pass 1: Exact match resolution
  ...
  - [ ] 6.3 Implement Pass 2: Alias match resolution
  ...
  - [ ] 6.4 Implement Pass 3: Semantic similarity resolution
  ...
  - [ ] 6.5 Implement entity resolution orchestrator
  ...
  - [ ]* 6.6 Write property test for exact match resolution confidence
  ...
  - [ ]* 6.7 Write property test for semantic resolution threshold
    - **Property 6: Semantic Resolution Threshold**
    - **Validates: Requirements 3.7**
    - Test that semantic matches above 0.92 with gap >= 0.03 merge correctly

  - [ ]* 6.8 Write property test for resolution conflict logging
  ...
  - [ ]* 6.9 Write unit tests for entity extraction and resolution
...
- [ ] 7. Fact extraction with pack-aware prompts and supersession
  - [ ] 7.1 Implement pack-aware fact extraction prompt assembly
  ...
  - [ ] 7.2 Implement predicate validation and custom predicate tracking
  ...
  - [ ] 7.3 Implement fact supersession resolver
  ...
  - [ ] 7.4 Implement fact extraction orchestrator
  ...
  - [ ]* 7.5 Write property test for pack-aware prompt assembly
  ...
  - [ ]* 7.6 Write property test for canonical predicate classification
  ...
  - [ ]* 7.7 Write property test for custom predicate occurrence tracking
  ...
  - [ ]* 7.8 Write property test for fact supersession
  ...
  - [ ]* 7.9 Write property test for predicate pack isolation
  ...
  - [ ]* 7.10 Write unit tests for fact extraction and supersession
...
- [ ] 8. Background worker and offline pipeline orchestration
  - [ ] 8.1 Implement episode processing via tokio spawned tasks
  ...
  - [ ] 8.2 Implement episode embedding generation in offline pipeline
  ...
  - [ ] 8.3 Implement full extraction pipeline orchestrator
  ...
  - [ ] 8.4 Implement extraction metrics logging
  ...
  - [ ] 8.5 Implement scheduled tasks via tokio
  ...
  - [ ]* 8.6 Write property test for asynchronous episode ingestion
  ...
  - [ ]* 8.7 Write property test for extraction metrics completeness
  ...
  - [ ]* 8.8 Write unit tests for background worker
...
- [ ] 9. Checkpoint - Extraction quality gate (50 episodes)
...
- [ ] 10. Intent classification and retrieval profiles
  - [ ] 10.1 Implement intent classifier
  ...
  - [ ] 10.2 Implement retrieval profile mapper
  ...
  - [ ] 10.3 Implement fact_lookup retrieval profile
  ...
  - [ ] 10.4 Implement episode_recall retrieval profile
  ...
  - [ ] 10.5 Implement graph_neighborhood retrieval profile
  ...
  - [ ] 10.6 Implement procedure_assist retrieval profile
  ...
  - [ ] 10.7 Implement retrieval profile executor with parallel execution
  ...
  - [ ]* 10.8 Write property test for task class validity
  ...
  - [ ]* 10.9 Write property test for retrieval profile mapping and cap
  ...
  - [ ]* 10.10 Write property test for cycle prevention in graph traversal
  ...
  - [ ]* 10.11 Write unit tests for classification and retrieval
...
- [ ] 11. Memory weight modifiers and four-dimension ranking
  - [ ] 11.1 Implement memory weight modifiers
  ...
  - [ ] 11.2 Implement four-dimension ranker
  ...
  - [ ] 11.3 Implement salience score computation
  ...
  - [ ]* 11.6 Write unit tests for ranking and weighting
...
- [ ] 12. Hot and warm tier management
  - [ ] 12.1 Implement hot tier promotion logic
  ...
  - [ ] 12.2 Implement hot tier demotion logic
  ...
  - [ ] 12.3 Implement hot tier budget enforcement
  ...
  - [ ] 12.4 Implement warm tier archival logic
  ...
  - [ ]* 12.5 Write property test for hot tier constraints
  ...
  - [ ]* 12.6 Write unit tests for tier management
...
- [ ] 13. Context package compilation with XML and JSON output
  - [ ] 13.1 Implement context compiler
  ...
  - [ ] 13.2 Implement structured output format (XML-like tags)
  ...
  - [ ] 13.3 Implement compact output format (JSON)
  ...
  - [ ] 13.4 Implement compilation audit logging
  ...
  - [ ]* 13.8 Write unit tests for context compilation
...
- [ ] 14. Checkpoint - Online pipeline integration testing
...
- [ ] 15. MCP interface implementation
  - [ ] 15.1 Implement loom_learn MCP endpoint
